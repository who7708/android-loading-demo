 ...
 * @since 2021/02/20
 */
public class MvpActivity extends AppCompatActivity implements StudentView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        KProgressHUD kProgressHUD = KProgressHUD.create(MvpActivity.this)
        ...
        studentPresenter = new StudentPresenter(MvpActivity.this, kProgressHUD);

        // 绑定 view 对象
        studentPresenter.attachView(MvpActivity.this);
